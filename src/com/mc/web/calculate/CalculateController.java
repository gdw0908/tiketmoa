...
public class CalculateController {
	...
	@RequestMapping("/admin/calculate/deadline.do")
	public String deadline(@RequestParam Map<String, String> params, HttpServletRequest request, HttpSession session) throws Exception{
		...
		return "/admin/calculate/deadline";
	}
	
	@RequestMapping("/admin/calculate/deadline_proc.do")
	public String deadline_proc(@RequestParam Map<String, String> params, HttpServletRequest request, HttpSession session) throws Exception{
		...
		request.setAttribute("redirect", "/admin/calculate/deadline.do");
		
		return "message";
	}
	
	@RequestMapping("/admin/calculate/deadline_excel.do")
	...
	@RequestMapping("/admin/calculate/deadline_cancel.do")
	public String deadline_cancel(@RequestParam Map<String, String> params, HttpServletRequest request, HttpSession session) throws Exception{
		...
		return "/admin/calculate/deadline_cancel";
	}
	
	@RequestMapping("/admin/calculate/deadline_re_proc.do")
	public String deadline_re_proc(@RequestParam Map<String, String> params, HttpServletRequest request, HttpSession session) throws Exception{
		...
		if("".equals(date)){
			...
			request.setAttribute("redirect", "/admin/calculate/deadline_cancel.do?date="+date);
		...
		request.setAttribute("redirect", "/admin/calculate/deadline_cancel.do");
		
		return "message";
	}
	
	@RequestMapping("/admin/calculate/deadline_cancel_proc.do")
	...
	@RequestMapping("/admin/calculate/confirm_list.do")
	public String confirm_list(@RequestParam Map<String, String> params, HttpServletRequest request, HttpSession session) throws Exception{
		...
		request.setAttribute("params", params);
		return "/admin/calculate/confirm_list";
	}
	
	@RequestMapping("/admin/calculate/confirm_view_detail.do")
	public String confirm_view_detail(@RequestParam Map<String, String> params, HttpServletRequest request, HttpSession session) throws Exception{
		...
		request.setAttribute("params", params);
		return "/admin/calculate/confirm_view_detail";
	}
	
	@RequestMapping("/admin/calculate/confirm_view_detail_excel.do")
	...
	@RequestMapping("/admin/calculate/confirm_view.do")
	public String confirm_view(@RequestParam Map<String, String> params, HttpServletRequest request, HttpSession session) throws Exception{
		...
		return "/admin/calculate/confirm_view";
	}
	
	@RequestMapping("/admin/calculate/confirm_proc.do")
	...
	@RequestMapping("/admin/calculate/confirm_excel.do")
	...
	@RequestMapping("/admin/calculate/day_search.do")
	public String day_search(@RequestParam Map<String, String> params, HttpServletRequest request, HttpSession session) throws Exception{
		...
		return "/admin/calculate/day_search";
	}
	
	@RequestMapping("/admin/calculate/day_excel.do")
	...
	@RequestMapping("/admin/calculate/week_search.do")
	public String week_search(@RequestParam Map<String, String> params, HttpServletRequest request, HttpSession session) throws Exception{
		...
		return "/admin/calculate/week_search";
	}
	
	@RequestMapping("/admin/calculate/week_excel.do")
	...
	@RequestMapping("/admin/calculate/month_search.do")
	public String month_search(@RequestParam Map<String, String> params, HttpServletRequest request, HttpSession session) throws Exception{
		...
		return "/admin/calculate/month_search";
	}
	
	@RequestMapping("/admin/calculate/month_excel.do")
	...
	@RequestMapping("/admin/calculate/branch_search.do")
	public String branch_search(@RequestParam Map<String, String> params, HttpServletRequest request, HttpSession session) throws Exception{
		...
		return "/admin/calculate/branch_search";
	}
	
	@RequestMapping("/admin/calculate/branch_excel.do")
	...
	@RequestMapping("/admin/calculate/year_search.do")
	public String year_search(@RequestParam Map<String, String> params, HttpServletRequest request, HttpSession session) throws Exception{
		...
		return "/admin/calculate/year_search";
	}
	
	@RequestMapping("/admin/calculate/year_excel.do")
