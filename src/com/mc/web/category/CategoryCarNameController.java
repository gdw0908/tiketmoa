...
@Controller
@RequestMapping("/admin/goods/inventory/inventory_cate3.do")
public class CategoryCarNameController {
	

	Logger log = Logger.getLogger(this.getClass());
	
	@Autowired
	private CategoryCarNameDAO CategoryCarNameDAO;
	...
	public String list(@RequestParam Map<String, String> params, HttpServletRequest request, HttpSession session) throws Exception{
		...
		return "/admin/goods/inventory/inventory_cate3";
	}
	...
	public String insert(@RequestParam Map<String, String> params, HttpServletRequest request, HttpSession session) throws Exception{
		...
		request.setAttribute("redirect", "/admin/goods/inventory/inventory_cate3.do");
		return "message";
	}
