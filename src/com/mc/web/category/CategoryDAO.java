...
public class CategoryDAO extends EgovAbstractMapper {
	...
	public Object getUpCodeCount(Map<String, String> params) {
		return selectByPk("category.getCountList", params);
	}
	
	public void getUpdateUseData(Map<String, String> params) {
		update("category.getUpdateUSEData", params);
	}
	
	public void getUpdateModifyData(Map<String, String> params) {
		update("category.getUpdateModifyData", params);
	}

	public void getInsertRow(Map<String, String> params) {
		insert("category.getInsertRow", params);
	}
	
	public void getInsertQry(Map<String, String> params) {
		insert("category.getInsertQry", params);
	}
	

	public Object getArticle(Map<String, String> params) {
		return selectByPk("category.getViewList", params);
	}
	
	public Object getChildList(Map<String, String> params)
	{
		return list("category.getChlidList", params);
	}

	public Object getPageInfo(Map<String, String> params) {
		return selectByPk("category.getPage_info", params);
	}
