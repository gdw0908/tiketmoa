...
@Controller
@RequestMapping("/admin/goods/inventory/inventory_cate2.do")
public class CategoryProduceController {
	

	Logger log = Logger.getLogger(this.getClass());
	
	@Autowired
	private CategoryProduceDAO categoryProduceDAO;
	...
	public String list(@RequestParam Map<String, String> params, HttpServletRequest request, HttpSession session) throws Exception{
		...
		return "/admin/goods/inventory/inventory_cate2";
	}
	...
	public String insert(@RequestParam Map<String, String> params, HttpServletRequest request, HttpSession session) throws Exception{
		...
		request.setAttribute("redirect", "/admin/goods/inventory/inventory_cate2.do");
		return "message";
