...
function list(value){
	location.replace("?menu=${param.menu }&sido=${param.sido}&sigungu=${param.sigungu}&dong=${param.dong}&keyword=${param.keyword}&rows=" + value);
}
</script>
</head>
      ...
      <div class="sub_wrap">
		...
		<table class="sub_list_style_1">
          ...
          <tr>
			...
			<td>${item.ceo_nm }</td>
			<td class="img">
			  <a href="repair_view.do?menu=${param.menu }&amp;seq=${item.seq }&amp;cpage=${param.cpage }&amp;keyword=${param.keyword }&amp;sido=${param.sido }&amp;sigungu=${param.sigungu }&amp;dong=${param.dong }"><img src="/images/sub/see_g7_03.gif" alt="상세보기" /></a>
			</td>
          </tr>
          </c:forEach>
          </tbody>
