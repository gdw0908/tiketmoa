...
$(document).ready(function(){
	...
	//$("#other_list").load("/popup/cooperation/other_list.do?com_seq=${view.seq}&rows=2&cpage=1");
...
function other_listPage(page){
	$("#other_list").load("/mobile/popup/cooperation/other_list.do?com_seq=${view.seq}&rows=2&cpage="+page);
}
</script>
</head>
<body>
            ...
            <div class="con_2">
              ...
              <tr>
                ...
                <td class="i_type_2">
                  ...
                  <span class="btn">
                  <a href="javascript:;" onclick="document.frm.reset();"><img src="/images/mobile/common/btn_reset.gif" alt="초기화"></a>
	...
	<div class="sub_wrap">
          ...
          <div class="supply">
            ...
            <tr>
              ...
              <td>
                ...
                <!-- <p><img src="/images/sub/g7_15.gif" alt="도로명주소">도로명 서울특별시 동대문구 장한로2길 62</p> -->
              </td>
            </tr>
            ...
            <tr>
              ...
              <td>
                <p><strong>${view.tel }</strong></p>
                <p>${view.staff_tel }</p>
                <p>${view.staff_email }</p>
              </td>
            </tr>

            <tr>
              <th class="f_normal">업태 &gt; 종목</th>
              <td>${view.comptyp1 } &gt; ${view.comptyp2 }</td>
            </tr>
            ...
            <tr class="last">
              <td colspan="2">
                <a href="repair_list.do?menu=${param.menu }" >
                <img src="/images/sub/bt_g7_a.gif" alt="장착점 살펴보기">
                </a>
              </td>
            </tr>
	  ...
	  <!-- <div class="d_con2 d_con2g7" id="other_list">
      </div>
      <div class="view_top">
        <p class="btn_box btn_boxg7">
        <a href="list.do?menu=${param.menu }&amp;cpage=${param.cpage }&amp;keyword=${param.keyword }&amp;sido=${param.sido }&amp;sigungu=${param.sigungu }&amp;dong=${param.dong }"><img src="/images/article/board_btn3.gif" alt="목록으로"></a>
        </p>
      </div> -->
</body>
</html>
