...
<div class="wrap">
  <div class="sub_wrap">
    ...
    <div class="address_pop">
      <div class="cancel_img">환불 신청이 완료되었습니다.</div>
      <ul class="last">
        <li>※ 환불관련 정보는 <span>나의쇼핑정보&gt;환불/입금내역</span>에서 확인가능합니다.</li>
        <!-- <li>※ 결제수단이 <span>현금입금/온라인 이체인경우 고객센터</span>로 문의하시기 바랍니다.</li> -->
        <li>※ 결제수단이 신용카드인 경우 카드승인 환불 여부는 <span>카드사를 통해 3~5일(영업일 기준)후 확인 가능</span>합니다.</li>
      </ul>
