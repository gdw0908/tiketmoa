...
function return_send(cart_no){
	location.replace("/mobile/mypage/shopping/state/index.do?mode=m_return_result&cart_no=" + cart_no + "&sayu=" + $('#sayu').val());
	return;
}
      ...
      <div class="sub_wrap">
        ...
        <div class="address_pop">
          ...
          <div class="sub_list sub_list_a1">
            ...
            <ul>
              ...
              <div>
                ...
                <span class="cancel_i1"><strong>반품사유 : </strong><input type="text" id="sayu" name="sayu" class="input_m2"><!-- a class="btn_x" href="javascript:$('#sayu').val('')"><img src="/images/sub_2/c_input_cancel.gif" alt=""></a--></span>
          ...
          <div class="btn_bottom">
            ...
            <a href="javascript:;" onclick="return_send('${item.cart_no}')"><img src="/images/sub_2/btn_cancel_b1.gif" alt="반품신청"></a>
          </div>
        </div>
      </div>
      </div>