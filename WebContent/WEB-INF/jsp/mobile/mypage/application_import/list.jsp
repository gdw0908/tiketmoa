      ...
      <div class="sub_wrap">
		...
		<c:forEach items="${list }" var="article" varStatus = "status">
			<tr>
				...
				<td class="title">
					<a href="${servletPath }?mode=view&amp;article_seq=${article.article_seq }&amp;cpage=${params.cpage }&amp;rows=${params.rows }&amp;condition=${params.condition }&amp;keyword=${params.keyword }&amp;menu=menu1">
