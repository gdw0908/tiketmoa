	...
	<table class="write_style_1">
		...
		<tbody>
			...
			<tr>
			  	...
			  	<td>
<textarea cols="" rows="" name="conts" id="smarteditor_mobile" style="width:100%;height:150px;min-width:100%; display:none;" >
1. 브랜드       :<br>
2. 차량명/연식  :<br>
3. 지역         :<br>
4. 수리요구사항을 입력해주세요<br>
&nbsp;&nbsp;&nbsp;&nbsp;(비교전 견적금액, 견적서첨부, 수리할 사진및 내용)<br><br>
	...
	<div class="vr_btn">
 		...
 		<a href="${servletPath }?mode=list&amp;cpage=${params.cpage }&amp;rows=${params.rows }&amp;condition=${params.condition }&amp;keyword=${params.keyword }&amp;menu=menu2"><img src="/images/article/board_btn5.gif" alt="입력취소"></a>
	</div>
	</form>
