...
<div class="vr_btn">
  <a href="${servletPath }?mode=del&amp;article_seq=${view.article_seq }&amp;cpage=${params.cpage }&amp;rows=${params.rows }&amp;condition=${params.condition }&amp;keyword=${params.keyword }&amp;menu=menu2"><img src="/images/article/board_btn1_n.gif" alt="문의취소"></a>
  <a href="${servletPath }?mode=modifyForm&amp;article_seq=${view.article_seq }&amp;cpage=${params.cpage }&amp;rows=${params.rows }&amp;condition=${params.condition }&amp;keyword=${params.keyword }&amp;menu=menu2"><img src="/images/article/board_btn2.gif" alt="내용수정"></a>
</div>
</c:if>
