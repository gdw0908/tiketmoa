...
function changePart1(){
	$.getJSON("/json/list/old_code.codeList.do", {upcodeno : $("#part1").val()}, function(data){
		$("#part2").empty();
		$("#part2").append('<option value="">부품종류</option>');
		$("#part3").empty();
		$("#part3").append('<option value="">부품명</option>');
		$.each(data, function(i, o){
			$("#part2").append("<option value='"+o.code+"'>"+o.code_nm+"</option>");
		});
	});
}

function changePart2(){
	$.getJSON("/json/list/old_code.carpart.do", {upcodeno : $("#part2").val()}, function(data){
		$("#part3").empty();
		$("#part3").append('<option value="">부품명</option>');
		$.each(data, function(i, o){
			$("#part3").append("<option value='"+o.code+"'>"+o.code_nm+"</option>");
		});
	});
}
...
function seller_insert(){
	...
	var caryyyy = "";
	if($("#caryyyy").val() != ""){
		caryyyy = " ("+$("#caryyyy option:selected").val()+")";
	}	
...
function commissionCalc(){
	var commission = '${data.MemberInfo.commission}';
	if(!isNaN(parseFloat(Number(commission))) && commission != ''){//커미션 정보 
		if(document.frm.supplier_pricing_yn.value == 'Y'){//협력사 사용
			if(!isNaN(parseFloat(Number(document.frm.user_price.value))) && document.frm.user_price.value != ''){
				document.frm.supplier_price.value = parseFloat(document.frm.user_price.value) - Math.floor(parseFloat(document.frm.user_price.value) * parseFloat(commission) / 100);
			}else{
				document.frm.supplier_price.value = 0;
			}
		}else{
			document.frm.supplier_price.value = 0;
		}
...
<body>
	...
	<form name="frm" id="frm" action="seller_insert.do" method="POST" onsubmit="return seller_insert()">
	...
	<input type="hidden" id="gubun" name="gubun" value="1">
        ...
        <div class="regi_wrap">
          ...
          <div class="regi_input">
            ...
            <tr>
              ...
              <td>
                <select name="part1" id="part1" class="select_sm" onchange="changePart1()">
            ...
            <tr>
              ...
              <td>
                <select name="part2" id="part2" class="select_sm" onchange="changePart2()">
            ...
            <tr>
              <th scope="row">※ 제조사</th>
              <td>
                <select name="carmakerseq" id="carmakerseq" class="select_sm" onchange="changeCarmaker()">
            ...
            <tr>
              <th scope="row">※ 차량명</th>
              <td>
                <select name="carmodelseq" id="carmodelseq" class="select_sm" onchange="changeCarmodel()">
            ...
            <tr>
              <th scope="row">※ 모델명</th>
              <td>
                <select name="cargradeseq" id="cargradeseq" class="select_sm">
          ...
          <div class="regi_price_box">
            ...
            <div class="price_2">
              ...
              <div class="p_input">
                ...
                <span><strong>판매가격</strong></span>
                <span>
                <input type="text" name="supplier_price" class="input_r1" value="0" readonly="readonly"> 원
                </span>
                </p>
      ...
      <div class="regi_bottom">
        ...
        <div class="regi_bottom_btn">
          ...
          <a class="rb_3" href="javascript:seller_insert();"><img src="/images/mobile/sub/res_btn_5.gif" alt="상품등록"></a>
          </span>
        </div>
      </div>
