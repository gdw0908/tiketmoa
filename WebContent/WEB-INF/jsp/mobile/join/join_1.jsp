...
<%
    ...
    String sReturnUrl = home_url+"/CheckPlusSafe/checkplus_success_m.jsp";      // 성공시 이동될 URL
    String sErrorUrl = home_url+"/CheckPlusSafe/checkplus_fail_m.jsp";          // 실패시 이동될 URL
...
<div class="wrap">
    <div class="title_rocation"><img src="/images/mobile/join/title_rocation1.gif" alt=""></div>
    ...
    <div class="j_wrap">
      ...
      <div class="t_box1">
        <p>
        파츠모아에서는 깨끗하고 <strong>안전한 인터넷 서비스 이용을 위해 본인확인</strong>을 받고 있습니다. <br>
      ...
      <div class="authentication">
        ...
        <div class="phone">
          ...
          <p><img class="btn" src="/images/join/phone_authentication.gif" alt="휴대폰 본인인증 이미지" ></p>

          <dl>
          <dt>휴대폰인증 서비스</dt>
          <dd>
          이용자의 개인정보를 보호하기 위해 웹사이트에
          주민등록번호를 제공하지 않고 본인확인 하는
          인터넷상의 개인식별번호 서비스입니다.
          </dd>
           <dd class="btn"><img class="btn" src="/images/join/phone_auth_btn_off.gif" alt="휴대폰 본인인증" onclick = "checkReadName();" style = "cursor:pointer;"></dd>  
           <!--<dd><a href = "/mobile/join/join_2.do"><img class="btn" src="/images/join/phone_auth_btn_off.gif" alt="휴대폰 본인인증" style = "cursor:pointer;"></a></dd> -->
          </dl>
        ...
        <div class="ipin">
          ...
          <p><img class="btn" src="/images/join/ipin_authentication.gif" alt="아이핀 본인인증 이미지"></p>
          ...
          인터넷상의 개인식별번호 서비스입니다.
           ...
           <dd class="btn"><a href="#"><img class="btn" src="/images/join/ipin_auth_btn_off.gif" alt="아이핀 본인인증" onclick = "iPinPop();" style = "cursor:pointer;"></a></dd>  
          <!--<dd><a href = "/mobile/join/join_2.do"><img class="btn" src="/images/join/ipin_auth_btn_off.gif" alt="아이핀 본인인증" style = "cursor:pointer;"></a></dd>-->
          </dl>
	  ...
	  <p class="warning">※ 입력하신 주민등록번호는 신용평가기관에 <strong>본인확인용으로 제공되며, 회원정보에 저장하지 않습니다.</strong>
