...
function go_search(){
	$('#frm').attr('action', '/giftcard/admin/calculate/branch_search.do');
	$('#frm').submit();
}
...
function go_excel(){
	...
	$('#frm').attr('action', '/giftcard/admin/calculate/branch_excel.do');
	$('#frm').submit();
}
...
<div id="main">
  <div class="titlebar">
    <h2>분기정산조회</h2>
    <div> <span>통합관리</span> &gt; <span>정산관리</span> &gt; <span class="bar_tx">분기정산조회</span> </div>
  </div>
  <div class="container"> 
    <div class="contents">
    <form action="/giftcard/admin/calculate/branch_search.do" method = "post" name = "frm" id = "frm">
      <table class="style_1">
         <colgroup>
          <col width="10%" />
          <col width="*" />
