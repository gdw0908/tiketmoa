	...
	<div class="details_info">
		...
		<table class="details_style_1" style="margin-top:10px;">
			...
			<tbody>
				...
				<tr>
					<td style="text-align:left;"colspan="2" class="carall_pop">${data.conts }</td>
				</tr>				
	  		</tbody>
		</table>
	</div>
...
$(document).ready(function(){
	nmap({ngTitle:"${data.com_nm}" ,ngXcoord:"${data.x_coord}", ngYcoord:"${data.y_coord}", ngWidth: 550, ngHeight:342});	
})
</script>