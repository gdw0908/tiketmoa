						...
						<li>
			              	<div>
			              		...
			              		<c:if test="${empty files[0].uuid }">
			              			...
			              			<input type="hidden" name="virtual_file_yn" value="Y">
			              			<input type="checkbox" name="image_check" value="" onclick="return false;">
			              			<img src="/images/mobile/sub/ssub_res_imgn2.gif" alt="파일추가" onclick="fileadd('1')">
			              		</c:if>
			              		</label>
			              	</div>
		              	</li>
            	...
            	<table class="write_style_1" style="margin-top:30px;">
              		...
              		<tbody>
						...
						<tr>
							...
							<td>
								...
								<c:set var="tel" value="${fn:split(view.tel,'-') }"/>
						    		...
						    		- <input type="number" pattern="[0-9]*" inputmode="numeric" id="charge_tel2" name="charge_tel2" class="input_3 ws_2" value="${tel[1] }"> - <input type="number" pattern="[0-9]*" inputmode="numeric" id="charge_tel3" name="charge_tel3" value="${tel[2] }" class="input_3 ws_2">
								</p>
						...
						<tr>
							<th>브랜드</th>
							<td>
								<select name="carmakerseq" class="select_1" >
						...
						<tr>
							...
							<td>
								<label><input type="checkbox" name="insurance_yn" value="Y" <c:if test="${view.insurance_yn == 'Y' }">checked="checked"</c:if>/> 보험수리</label>
								<label><input type="checkbox" name="rent_yn" value="Y" <c:if test="${view.rent_yn == 'Y' }">checked="checked"</c:if>/> 픽업서비스</label>
								<label><input type="checkbox" name="pickup_yn" value="Y" <c:if test="${view.pickup_yn == 'Y' }">checked="checked"</c:if>/> 렌터카</label>
							</td>
						</tr>						
		                <tr>
		                  ...
		                  <td>
			                  <textarea cols="" rows="" name="content" style="width:100%;height:100px;min-width:100%; display:none;" id="smarteditor_mobile">${view.content }</textarea>
		                  </td>
		                </tr>
              		</tbody>
            	</table>
