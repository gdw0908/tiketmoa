...
<div class="wrap">
      <div id="sub">
        ...
        <div class="contents">
		 ...
		 <input type = "hidden" name = "mode" value = "userModify">
		 <input type = "hidden" name = "member_seq" value = "${userData.member_seq }">
          ...
          <div class="user_info_box">
            ...
            <tr>
              ...
              <td><input type="password" id="member_pw_df" value = "" name="member_pw_df" class="input_3 ws_1" placeholder="현재 비밀번호를 입력해 주세요"></td>
            </tr>
            ...
            <tr>
              ...
              <td>
                ...
                - <input type="text" id="tel1" name="tel1" value = "${tel1 }"class="input_3 ws_2" maxlength = "4"> - <input type="text" id="tel2" name="tel2" class="input_3 ws_2" value = "${tel2 }" maxlength = "4">
              </td>
            </tr>
            ...
            <tr>
			  ...
			  <input type="text" id="cell" name="cell" class="input_3 ws_2" value = "${cell }" maxlength = "3">
                - <input type="text" id="cell1" name="cell1" class="input_3 ws_2" value = "${cell1 }" maxlength = "4"> - <input type="text" id="cell2" name="cell2" class="input_3 ws_2" value = "${cell2 }" maxlength = "4">
			  </td>
            </tr>
            ...
            <tr>
              ...
              <td>
                <input type="text" id="email" name="email" class="input_3" value = "${email }"> @ <input type="text" id="email1" name="email1" class="input_3" value = "${email1 }">
            ...
            <tr>
              ...
              <td><label><input type="radio" id="email_yn" name="email_yn" value = "Y" class="check" <c:if test = "${userData.email_yn eq 'Y' }">checked</c:if>> 수신함</label> <label style="margin-left:15px;"><input type="radio" id="email_yn" name="email_yn" value = "N" class="check" <c:if test = "${userData.email_yn eq 'N' }">checked</c:if>> 수신안함</label> <span class="c2">※ 주요 공지사항 및 알림 등은 설정에 관계 없이 발송됩니다.</span></td>
            </tr>

            <tr>
              <th scope="row"><b>*</b> 주소</th>
              <td class="adress">
                <p><input type="text" id="zip_cd" name="zip_cd" class="input_3 ws_2" readonly value = "${zip_code1 }"> - <input type="text" id="zip_cd1" name="zip_cd1" class="input_3 ws_2" readonly value = "<c:if test="${!(zip_code2 == null or zip_code2 == '' or zip_code2 == 'null')}">${zip_code2 }</c:if>">
                <a href="javascript:open_zipcode();"><img src="/images/sub_2/address_btn1.gif" alt="주소검색"></a> </p>
                <p><input type="text" id="addr1" name="addr1" class="input_3 ws_3" value = "${userData.addr1 }" readonly></p>
                <p class="last"><input type="text" id="addr2" name="addr2" class="input_3 ws_3" value = "${userData.addr2 }" ></p>
              </td>
            </tr>
