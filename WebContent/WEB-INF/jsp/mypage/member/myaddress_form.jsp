...
<div class="wrap">
      <div id="sub">
        ...
        <div class="contents">
          ...
          <div class="t_box1">
		  <p><strong>새로운 배송주소를 등록하시려면 주소록 추가하기를 눌러주세요.</strong> <a href="#" class="add_btn1"><img src="/images/sub_2/address_btn2.gif" alt="주소록 추가하기"></a></p>
		  </div>
			...
			<form name = "myAddressForm" id = "myAddressForm" method = "post" action = "${servletPath }" onsubmit = "return myAddressFormCheck()">
			  ...
			  <div class="sub_table_1">
				...
				<th scope="row"><span>배송지 주소</span></th>
	              <td>
	                <div class="input_box_1">
	                  ...
	                  <a href="#"><img src="/images/sub_2/pay_s_btn2.gif" alt="주소찾기" onclick = "open_zipcode();"></a> <label><input type="checkbox" id="default_yn" name="default_yn" class="check"  value = "Y" <c:if test = "${myaddress.default_yn eq 'Y'}">checked</c:if>> 주소록에 기본배송지로 저장</label>
	                </div>
	                <div class="input_box_1">
				...
				<tr>
	              ...
	              <td><input type="text" id="receiver_title" name="receiver_title" class="input_2 ws_3" value = "${myaddress.receiver_title }"> <label><input type="checkbox" id="" name="" class="check" onclick = "addOption();"> 수취인명과 동일하게 적용</label></td>
	            </tr>
			  ...
			  <input type = "image" src = "/images/sub_2/d_btn_4.gif">
			  <a href="javascript:history.back(-1);"><img src="/images/sub_2/d_btn_5.gif" alt="취소"></a>
			  </div>
			</form>
        </div>
      </div>
