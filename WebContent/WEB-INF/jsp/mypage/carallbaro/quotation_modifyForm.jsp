...
function ImageDraw(num,yyyy,mm,uuid,attach_nm){
 ...
 <div id="sub">
	...
	<input type="hidden" name="del_files" id="del_files" value=""/>
		...
		<table class="write_style_1">
			...
			<tbody>
				...
				<tr>
					...
					<td>
						...
						<c:set var="tel" value="${fn:split(view.tel,'-') }"/>
				    		...
				    		- <input type="text" id="charge_tel2" name="charge_tel2" value="${tel[1] }" class="input_3 ws_2"> - <input type="text" id="charge_tel3" name="charge_tel3" value="${tel[2] }" class="input_3 ws_2">
						</p>
				...
				<tr>
					...
					<td>
						<input type="text" id="carinfo" name="carinfo" class="input_1" value="${view.carinfo }" style="width:337px;">
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><textarea cols="" rows="" name="content" style="width:100%;" id="smarteditor">${view.content }</textarea></td>
				</tr>
			</tbody>
		</table>
		<div class="section">
		...
		<div class="vr_btn">
			<input type="image" src="/images/article/board_btn9.gif" alt="수정하기"/>  
