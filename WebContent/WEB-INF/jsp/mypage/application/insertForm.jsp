...
<%@ taglib uri="http://java.sun.com/jsp/jstl/functions" prefix="fn" %>
 <div id="sub">
        <div class="strapline">
          <h3><img src="/images/sub_2/h3_img_7.gif" alt="부품문의 국산차"></h3>
          <div class="state"> <span>홈</span> &gt; <span>고객센터</span> &gt; <span><strong>부품문의 국산차</strong></span> </div>
        </div>
        <div class="contents">
          <div class="write_top">
<!--
...
<tr>
  ...
  <td>
  <input type="radio" name="status" value="1" checked="checked"/> 전체공개 
  <c:if test="${(sessionScope.member.group_seq == 3 or sessionScope.member.group_seq == 1)}">
  <input type="radio" name="status" value="3"/> 협력사 공개	
  </c:if>
