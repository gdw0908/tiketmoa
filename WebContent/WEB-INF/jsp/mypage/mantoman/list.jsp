...
<div id="sub">
  ...
  <div class="contents">
    <div class="organize"><a href="/mypage/mantoman_late/index.do"><img src="/images/sub_2/car_all_img.gif" alt="비싼정비금액, 과잉정비 걱정 끝! 카올바로 에서 최상급 중고부품을 이용한 합리적인 가격의 정비사례를 만나보세요 정비사례보러가기"></a></div>
    <div class="list_top"> 
      ...
      <tbody>
        ...
        <c:forEach items="${list }" var="article" varStatus = "status">
          <tr>
            ...
            <td class="title"><a href="${servletPath }?mode=view&amp;article_seq=${article.article_seq }&amp;cpage=${params.cpage }&amp;rows=${params.rows }&amp;condition=${params.condition }&amp;keyword=${params.keyword }"> ${article.title }${article.public_yn == 'Y' ? '':'( 비공개 )'}
    ...
    <div class="vr_btn"><a href="${servletPath }?mode=insertForm"><img src="/images/article/board_btn6_n.gif" alt="견적등록"></a></div>
