  ...
  <div class="contents">
    ...
    <table class="list_style_1">
      ...
      <tbody>
        <tr>
          <td>3</td>
          <td class="title"><a href="/mypage/event/event_view.do"> 이벤트 두번째 글 </a></td>
          <td>2015-03-24</td>
          <td><img src="/images/article/ev_state_1.gif" alt="진행중"></td>
        </tr>
        <tr>
          <td>2</td>
          <td class="title"><a href="/mypage/event/event_view.do"> 이벤트 첫번째 글 </a></td>
          <td>2015-03-24</td>
    ...
    <div class="paging"> <span id="pagingWrap"> <b><a href="/mypage/notice/index.do?cpage=1&amp;rows=10&amp;condition=&amp;keyword=" onclick="return goPage(1);">1</a></b> </span> </div>
