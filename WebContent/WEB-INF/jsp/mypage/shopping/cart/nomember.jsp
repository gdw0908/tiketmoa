...
<body>
<form name="frmAGS_pay" method="post" action="/mypage/shopping/cart/non_member.do?mode=pay_ing">
	<div class="title_rocation">
      <div class="tr_wrap">
        <h3><img src="/images/sub_2/h4_img2.gif" alt="주문/결제"></h3>
        <ul>
    ...
    <h5 class="no_mem_type">1. 주문제품</h5>
          ...
          <div class="sub_table_1">
            ...
            <tr>
              ...
              <td><input type="text" id="m_member_nm" name="m_member_nm" class="input_2 ws_3" readonly="readonly" required="required"> <span><a href="javascript:checkReadName();"><img src="/images/join/no_mem_auth.gif" alt="본인인증"></a></span></td>
            </tr>
            <tr>
            ...
            <th scope="row"><span>배송지 주소</span></th>
              <td>
                <div class="input_box_1">
                  ...
                  <a href="javascript:openAddr();"><img src="/images/sub_2/pay_s_btn2.gif" alt="주소찾기"></a>
                </div>
                <div class="input_box_1">
