...
<body>
	<div class="title_rocation">
      <div class="tr_wrap">
        <h3><img src="/images/sub_2/h4_img3.gif" alt="주문완료"></h3>
        <ul>
            ...
            <div class="info_r">
              ...
              <div class="sub_table_1">
                ...
                <tr>
                  ...
                  <td>
                    <p>(${data.resultInfo.re_zipcd }) ${data.resultInfo.re_addra }</p>
                    <p>${data.resultInfo.re_addr1 } ${data.resultInfo.re_addr2 }</p>
                  </td>
                </tr>
                <tr>
