...
<body>
<form name="frmAGS_pay" method="post" action="/mypage/shopping/cart/index.do?mode=pay_ing">
	<div id="sub">
        <div class="strapline">
        ...
        <div class="contents">
          <div class="title_rocation">
            <h4><img src="/images/sub_2/h4_img2.gif" alt="주문/결제"></h4>
            <ul>
              <li><img src="/images/sub_2/cart_r1.gif" alt="장바구니"></li>
              <li><img src="/images/sub_2/cart_r2_on.gif" alt="주문/결제"></li>
            ...
            <td id = "fee_price">
            	 ...
            	 <c:choose>
	              	...
	              	<select name="cod_yn" onchange="changeCod('${item.cart_no }', this.value)">
	              		...
	              		<option value="N" <c:if test="${item.cod_yn eq 'N'}">selected="selected"</c:if>>착 불</option>
	              	</select><br />
          ...
          <ul class="sub_list_1">
            <li><strong>PARTSMOA</strong>는 통신판매중개자이며 통신판매의 당사자가 아닙니다. 따라서 <strong>PARTSMOA</strong>는 상품ㆍ거래정보 및 거래에 대하여 책임을 지지 않습니다.</li>
          </ul>
          ...
          <div class="sub_table_1">
            ...
            <tr>
              ...
              <td>
                <span>
                <label><input type="radio" name="basongji_gubun" class="radio" value="1" checked="checked"> 기본배송지</label>
                <label><input type="radio" name="basongji_gubun" class="radio" value="2"> 새로운배송지</label>
                <label><input type="radio" name="basongji_gubun" class="radio" value="3"> 회원정보주소</label>
                </span>
                <span>
                최근배송지 : <label><input type="radio" name="basongji_gubun" class="radio" value="4"> 기본 주소</label> <a href="#" class="btn_img openMask"><img src="/images/sub_2/pay_s_btn4.gif" alt="주소록 보기"></a>
                </span>
              </td>
            </tr>
            <tr>
              <td>
                <div class="input_box_1">
                  ...
                  <a href="javascript:openAddr();"><img src="/images/sub_2/pay_s_btn2.gif" alt="주소찾기"></a> <label><input type="checkbox" name="default_yn" value="Y" class="check"> 주소록에 기본배송지로 저장</label>
                </div>
                <div class="input_box_1">
            ...
            <tr>
              ...
              <td>
                ...
                <div class="middle">
                  ...
                  <p><input type="text" name="message" class="input_2 ws_4 message" maxlength="100"> ( 0/100 bytes )</p>
          ...
          <div class="pricecheck">
            <div class="p_check1">
              ...
              <div class="bottom">
                ...
                <p class="pb_type"><span class="pb_l">선결제배송비</span><span class="pb_r">${suf:getThousand(fee_price) }원</span></p>
              </div>
            </div>
            <div class="p_check2">
              <div class="top">
          ...
          <div class="pay_btn"> 
	          <a href="#" onclick="return Pay(frmAGS_pay)"><img src="/images/sub_2/btn_pay_2.gif" alt="결제하기"></a> 
	          <a href="/mypage/shopping/cart/index.do"><img src="/images/sub_2/btn_pay_3.gif" alt="장바구니로 가기"></a> 
	      </div>
            ...
            <div class="address_bg">
              <div class="address_pop">
                ...
                <div class="pop_strapline">
                  <h3><img src="/images/sub_2/h3_img_4_pop.gif" alt="배송주소록"></h3>
                  <!-- div class="state"> <span>홈</span> &gt; <span>고객센터</span> &gt; <span><strong>나의쇼핑</strong></span> </div-->
                ...
                <tr>
                  ...
                  <td class="title">[${item.zip_cd }] ${item.addr1 } ${item.addr2 }</td>
                  <td>${item.cell }</td>
                  <td><a href="javascript:selectJuso('${item.seq }');"><img src="/images/sub_2/address_pop_btn1.gif" alt="선택하기"></a></td>
                </tr>
                </c:forEach>
                </tbody>
                </table>
...
%>
<input type="hidden" name="m_member_nm" value="${memberInfo.member_nm }"/>
<input type="hidden" name="m_zip_cd" value="${memberInfo.zip_cd }"/>
<input type="hidden" name="m_addr1" value="${memberInfo.addr1 }"/>
<input type="hidden" name="m_addr2" value="${memberInfo.addr2 }"/>
<input type="hidden" name="m_cell" value="${memberInfo.cell }"/>
<input type="hidden" name="m_tel" value="${memberInfo.tel }"/>
<input type="hidden" name="m_email" value="${memberInfo.email }"/>
...
<input type="hidden" name="card_hp" value="${memberInfo.cell }"/>
<input type="hidden" name="UserId" value="${memberInfo.member_id }"/>
...
<input type="hidden" name="OrdPhone" value="${memberInfo.cell }"/>
<input type="hidden" name="OrdAddr" value="${memberInfo.addr1 } ${memberInfo.addr2 }"/>
