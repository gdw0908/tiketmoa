  ...
  <div id="tabNav_j1" class="join_tab pw_search_tab">
    ...
    <div id="tabNav0101" style="display: block;">
      ...
      <div class="authentication auth_2">
        ...
        <form name = "search_email_form" id = "search_email_form" method = "post" action = "/join/pw_search_2.do" onsubmit = "return search_email_form_fnc();">
    ...
    <div id="tabNav0102" style="display: none;">
      ...
      <form name = "busi_search_form" id = "busi_search_form" method = "post" action = "/join/pw_search_2.do" onsubmit = "return busi_search_form_chk();">
        <input type = "hidden" name = "mode" id = "mode" value = "pw_search"/>
...
<form name = "next_step" id = "next_step" method = "post" action = "/join/pw_search_2.do">
