      ...
      <c:if test = "${params.tab_val eq '2' }">
        <div class="licensee_3">
          <dl class="type_2">
            ...
            <dd class="btn_2"> <a href="/"><img class="btn" src="/images/join/join4_btn_1.gif" alt=""></a> <a href="/login/login.do"><img class="btn" src="/images/join/join4_btn_2.gif" alt=""></a> </dd>
          </dl>
        </div>
      </c:if>
      <div class="b_gui">
