  ...
  <div id="tabNav_j1" class="join_tab">
        ...
        <table class="join_style_1">
          <tbody>
            ...
            <tr>
              ...
              <td class="fs_2"><%=request.getParameter("member_nm")%>
    ...
    -->
            ...
            <tr>
              ...
              <td><input type="text" id="cell1" name="cell1" class="input_j1 ws_3" maxlength = "3">
                -
                <input type="text" id="cell2" name="cell2" class="input_j1 ws_4" maxlength = "4">
                -
                <input type="text" id="cell3" name="cell3" class="input_j1 ws_4" maxlength = "4"></td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td><input type="text" id="email1" name="email1" class="input_j1 ws_5">
                @
            ...
            <tr>
              ...
              <td><p>
                  <label>
                    <input type="checkbox" id="email_yn" name="email_yn" class="check" value = "Y">
                    수신함</label>
                  <label style="margin-left:15px;">
                    <input type="checkbox" id="email_yn" name="email_yn" class="check"  value = "N">
                    수신안함</label>
                </p>
...
<form name = "move_form" id = "move_form" method = "post" action = "/join/join_3_1.do">
