    ...
    <form id="wFrm" name="frm" method="post" novalidate="novalidate">
      <table class="style_1" style="table-layout:fixed;">
        ...
        <tr>
          <th>카올바로 회원여부</th>
          <td colspan="3">
          	<select title="카올바로회원" data-ng-model="form.carall" data-ng-init="form.carall = 'Y'">
      ...
      <table id="member_t" class="style_1" style="margin-top:15px;">
         <colgroup>
        <col width="10%" />
        <col width="*" />
        </colgroup>
        <tr data-ng-repeat="item in form.memberList">
          ...
          <td style="padding-right:15px;">
            <table class="style_4" style="margin-top:0px;">
              ...
              <tr>
                <th>비밀번호</th>
                <td class="left"><input type="password" class="input_1" data-ng-model="item.member_pw" data-ng-minlength="4" data-ng-maxlength="16" data-ng-pattern="/([a-zA-Z_]+[0-9]+[^a-zA-Z0-9_]*)|([a-zA-Z_]+[^a-zA-Z0-9_]+[0-9]*)|([0-9]+[a-zA-Z_]+[^a-zA-Z0-9_]*)|([0-9]+[^a-zA-Z0-9_]+[a-zA-Z_]*)|([^a-zA-Z0-9_]+[0-9]+[a-zA-Z_]*)|([^a-zA-Z0-9_]+[a-zA-Z_]+[0-9]*)/" required/></td>
                <th>비밀번호확인</th>
