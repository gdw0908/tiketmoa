...
function go_search(){
	...
	$('#frm').attr('action', '/admin/statistics/statistics.do');
	$('#frm').submit();
}
...
function go_excel(){
	...
	$('#frm').attr('action', '/admin/statistics/statistics_excel.do');
	$('#frm').submit();
}
...
<div id="main">
  ...
  <div class="container">
    <div class="contents">
    <form action="/admin/statistics/statistics.do" method = "post" name = "frm" id = "frm">
      <table class="style_1">
         <colgroup>
          <col width="10%" />
          <col width="*" />
