...
<frameset rows="45,*" frameborder="no" framespacing="0">
  <frame src="inc/header.do"  noresize="noresize" />
  <frameset cols="281,*" >
    <frame src="/admin/inc/left.do" style="width: 281px;" scrolling="no" noresize="noresize" name="leftFrame"/>
    <frame src="/admin/login/login_img.do"  noresize="noresize" name="bodyFrame"/>
  </frameset>
