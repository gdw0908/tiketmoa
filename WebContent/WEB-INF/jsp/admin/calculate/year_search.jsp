...
function go_search(){
	$('#frm').attr('action', '/admin/calculate/year_search.do');
	$('#frm').submit();
}
...
function go_excel(){
	...
	$('#frm').attr('action', '/admin/calculate/year_excel.do');
	$('#frm').submit();
}
</script>
</head>
...
<div id="main">
  ...
  <div class="container"> 
    <div class="contents">
    <form action="/admin/calculate/year_search.do" method = "post" name = "frm" id = "frm">
