...
function go_search(){
	$('#frm').attr('action', '/admin/calculate/branch_search.do');
	$('#frm').submit();
}
...
function go_excel(){
	...
	$('#frm').attr('action', '/admin/calculate/branch_excel.do');
	$('#frm').submit();
}
...
<div id="main">
  ...
  <div class="container"> 
    <div class="contents">
    <form action="/admin/calculate/branch_search.do" method = "post" name = "frm" id = "frm">
      <table class="style_1">
         <colgroup>
          <col width="10%" />
          <col width="*" />
