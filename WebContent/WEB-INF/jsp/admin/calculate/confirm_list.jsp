...
function go_search(){
	...
	$("#cpage").val(1);
	$('#frm').attr('action', '/admin/calculate/confirm_list.do');
	$('#frm').submit();
}
...
<div id="main">
  ...
  <div class="container"> 
    <div class="contents">
      <form action="/admin/calculate/confirm_list.do" method = "post" name = "frm" id = "frm">
      ...
      <table class="style_6">
        ...
        <tr>
          ...
          <td>${vo.confirm_dt}</td>
          <td class="blue"><a href="/admin/calculate/confirm_view.do?calculate_confirm_seq=${vo.calculate_confirm_seq }">${vo.calculate_confirm_seq }</a></td>
          <td>${vo.period}</td>
          <td>${vo.days}</td>
          <td class="left" >
            ${vo.cooperations}
