...
function go_search(){
	...
	$('#frm').attr('action', '/admin/calculate/deadline.do');
	$('#frm').submit();
}
...
function go_proc(){
	...
	$('#frm').attr('action', '/admin/calculate/deadline_proc.do');
	$('#frm').submit();
}
...
function go_excel(){
	...
	$('#frm').attr('action', '/admin/calculate/deadline_excel.do');
	$('#frm').submit();
}
</script>
</head>
<body>
<form action="/admin/calculate/deadline.do" method = "post" id = "frm" name = "frm">
