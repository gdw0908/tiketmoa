...
function go_re(){
	...
	$('#frm').attr('action', '/admin/calculate/deadline_re_proc.do');
	$('#frm').submit();
}
...
function go_cancel(){
	...
	$('#frm').attr('action', '/admin/calculate/deadline_cancel_proc.do');
	$('#frm').submit();
}
...
<div id="main">
  ...
  <div class="container"> 
    ...
    <div class="contents">
    <form action="/admin/calculate/deadline_cancel.do" method = "post" id = "frm" name = "frm">
