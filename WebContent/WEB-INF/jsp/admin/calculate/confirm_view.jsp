...
function go_proc(){
	...
	$('#frm').attr('action', '/admin/calculate/confirm_proc.do');
	$('#frm').submit();
}

function go_excel(){
	$('#frm').attr('action', '/admin/calculate/confirm_excel.do');
	$('#frm').submit();
}
function dialog_pop(order_comseq,order_date,t){
	...
	$("#modal_dialog2").load("/admin/calculate/confirm_view_detail.do", {com_seq : order_comseq, odate : order_date, type:t});
...
<body>
<form action="/admin/calculate/confirm_view.do" method = "post" id = "frm" name = "frm">
...
<form id="excelFrm" name="excelFrm" action="/admin/calculate/confirm_view_detail_excel.do" method="post">
