...
function go_insert()
{
	...
	{
		if(confirm("차량명을 등록하시겠습니까?")) jQuery("form[name='cateCarName_insert']").submit();
	}
}
  ...
  <div class="container"> 
    <div class="tab_menu">
      <ul class="tab">
        ...
        <li class="on"><a href="javascript:;" onclick = "goBody('/admin/goods/inventory/inventory_cate3.do');">차량명</a></li>
    ...
    <div class="contents">
       ...
       <form name="carNameSearchForm" action="${servletPath }" onsubmit="return goPage(1);" method = "post">
		...
		<input type = "hidden" name = "searchChk" value = "1"/>
	        <div class="r_btn">
	          <select title="제조사선택" name="condition" id="condition" class="cho2">
	          ...
	          <label>
	            <span style="font-weight: bold; padding: 0px 5px 0px 15px;">차량명</span><input type="text" class="input_1" id="keyword" name="keyword" value = "${params.keyword }"/>
	          </label>
		      ...
		      <form id = "cateCarName_insert" name = "cateCarName_insert" method = "post" action = "${servletPath }">
		       ...
		       <table class="style_1" style="table-layout: fixed;">
	            ...
	            <tr>
	              <th>제조사</th>
	              <td>
	               <select title="제조사선택" name="condition_insert" id="condition_insert" class="cho2">
		            <c:forEach items="${comInfo }" var="comInfoList">
