...
function go_insert()
{
	...
	{
		if(confirm("제조사를 등록하시겠습니까?")) jQuery("form[name='cateProduce_insert']").submit();
	}
}

function go_update()
{
	if(confirm("제조사를 수정하시겠습니까?")) jQuery("form[name='cateProduce_modify']").submit();
}
...
function  go_delete()
{
	...
	if(confirm("제조사를 삭제하시겠습니까?")) location.replace("${servletPath}?method=delete&cpage=${params.cpage}&rows=${params.rows}&carmakerseq=" + carmakerseq);
  ...
  <div class="container"> 
    <div class="tab_menu">
      <ul class="tab">
        ...
        <li class="on"><a href="javascript:;" onclick = "goBody('/admin/goods/inventory/inventory_cate2.do');">제조사</a></li>
