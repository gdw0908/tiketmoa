...
app.controller("listCtrl", function($scope, $window, $location, $routeParams, $compile, ajaxService, dialogService) {
	...
	$scope.login = function(item){
		...
		ajaxService.getJSON("/admin/login.do?mode=superLogin", item, function(data){
			if(data.rst == '1'){
	...
	$scope.passwordInit = function(item){
		...
		ajaxService.getJSON("/member/member.do?mode=passwordInit", item, function(data){
			if(data.rst == '1'){
...
app.controller("writeCtrl", function($scope, $window, $routeParams, ajaxService, dialogService) {
	...
	$scope.save = function(){
		...
		*/
		...
		ajaxService.getJSON("/member/member.do?mode=write", {jData : JSON.stringify($scope.form)}, function(data){
			$scope.list();
		});
	}
});
app.controller("modifyCtrl", function($scope, $window, $routeParams, ajaxService, dialogService) {
	$scope.form = {};
	ajaxService.getJSON("/member/member.do?mode=view", {member_seq : $routeParams.member_seq}, function(data){
	...
	$scope.save = function(){
		...
		*/
		...
		ajaxService.getJSON("/member/member.do?mode=modify", {jData : JSON.stringify($scope.form)}, function(data){
			$scope.list();
		});
	}
