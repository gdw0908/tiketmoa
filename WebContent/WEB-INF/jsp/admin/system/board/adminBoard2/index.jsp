...
var app = angular.module("MyApp", ['dialogService', 'ngRoute', 'myUtil', 'myFilter', 'myPagination', 'myCommon', 'ui.sortable', 'myNmap', 'myEditor', 'ngSanitize']);
...
app.controller("modifyCtrl", function($scope, $window, $routeParams, $compile, $location, $sce, ajaxService, dialogService) {
	$scope.form = {};
	$scope.comment = {};
