...
app.controller("listCtrl", function($scope, $window, $routeParams, $compile, ajaxService, dialogService) {
	...
	$scope.listDel = function(){
		...
		if(confirm("삭제하시겠습니까?")){
			ajaxService.getJSON("/admin/system/board/late/index.do?mode=del", {jData : '{"article_seq" : "'+del_seq+'"}'}, function(data){
				$scope.list();
			});
		}
	}
...
app.controller("writeCtrl", function($scope, $window, $routeParams, $rootScope, ajaxService, dialogService) {
	...
	$scope.save = function(){
		...
		ajaxService.getJSON("/admin/system/board/late/index.do?mode=write", {jData : JSON.stringify($scope.form)}, function(data){
			$scope.list();
		});
	}
});
...
app.controller("modifyCtrl", function($scope, $window, $routeParams, ajaxService, dialogService) {
	...
	$scope.comment = {};
	$scope.subcode = {};
	ajaxService.getJSON("/admin/system/board/late/index.do?mode=view", {article_seq : $routeParams.seq, board_seq : $scope.param.board_seq}, function(data){
		...
		ajaxService.getJSON("/admin/system/board/late/index.do?mode=commentList", {jData : JSON.stringify({article_seq : $routeParams.seq})}, function(data){
	...
	$scope.save = function(){
		...
		ajaxService.getJSON("/admin/system/board/late/index.do?mode=modify", {jData : JSON.stringify($scope.form)}, function(data){
			$scope.list();
		});
	}
	...
	$scope.del = function(){
		if(confirm("삭제하시겠습니까?")){
			ajaxService.getJSON("/admin/system/board/late/index.do?mode=del", {jData : JSON.stringify($scope.form)}, function(data){
				$scope.list();
			});
		}
	}
	...
	$scope.commentSubmit = function(){
		...
		ajaxService.getJSON("/admin/system/board/late/index.do?mode=commentInsert", {jData : JSON.stringify($scope.cfrm)}, function(data){
			ajaxService.getJSON("/admin/system/board/late/index.do?mode=commentList", {jData : JSON.stringify({article_seq : $routeParams.seq})}, function(data2){
				$scope.cfrm.conts = "";
	...
	$scope.commentReply = function(idx){
		...
		if(textarea != ""){
			...
			ajaxService.getJSON("/admin/system/board/late/index.do?mode=commentReply", {jData : JSON.stringify(array)}, function(data){
				ajaxService.getJSON("/admin/system/board/late/index.do?mode=commentList", {jData : JSON.stringify({article_seq : $routeParams.seq})}, function(data2){
					$scope.comment = data2.comment;
				});
			});				
	...
	$scope.commentDel = function(idx){
		if(confirm("정말 삭제하시겠습니까?")){
			ajaxService.getJSON("/admin/system/board/late/index.do?mode=commentDel", {jData : JSON.stringify({comment_seq : idx})}, function(data){
				ajaxService.getJSON("/admin/system/board/late/index.do?mode=commentList", {jData : JSON.stringify({article_seq : $routeParams.seq})}, function(data2){
					$scope.comment = data2.comment;
				});
			});	
	...
	$scope.commentUpdateWindow = function(idx){
		...
		ajaxService.getJSON("/admin/system/board/late/index.do?mode=commentReplyInfo", {comment_seq : idx}, function(data){
...
app.controller("replyCtrl", function($scope, $window, $routeParams, ajaxService, dialogService) {
	$scope.commentUpdate = function(){
		ajaxService.getJSON("/admin/system/board/late/index.do?mode=commentReplyUpdate", {jData : JSON.stringify($scope.model)}, function(data){
			ajaxService.getJSON("/admin/system/board/late/index.do?mode=commentList", {jData : JSON.stringify({article_seq : $routeParams.seq})}, function(data2){
