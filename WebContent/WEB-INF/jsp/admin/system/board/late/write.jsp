...
<div id="main">
  <div class="titlebar">
    <h2>구매후기</h2>
    <div> <span>통합관리</span> &gt; <span>시스템관리</span> &gt;<span>구매후기</span> &gt;<span class="bar_tx">등록</span> </div>
  </div>
  <div class="container"> 
    <div class="contents">
      ...
      <table class="style_1">
        ...
        <tr>
          ...
          <td>
            ...
            <select data-ng-model="form.codeno" data-ng-options="item.codeno as item.codenm for item in subcode" data-ng-init="form.cate_code = ''" required>
                 <option value="">===== 선택 =====</option>
            </select>
          </td>
        </tr>
