...
<div id="main">
  <div class="titlebar">
    <h2>카올바로</h2>
    <div> <span>통합관리</span> &gt; <span>시스템관리</span> &gt;<span>카올바로</span> &gt;<span class="bar_tx">등록</span> </div>
  </div>
  <div class="container"> 
    <div class="contents">
    <form id="wFrm" name="frm" method="post" novalidate="novalidate">
      <table class="style_1">
        ...
        <!-- <tr>
          <th>공개여부</th>
          <td>
          	<input type="radio" class="input_1" data-ng-model="form.public_yn" value="Y" data-ng-init="form.public_yn = 'Y'"/> 공개 
