    ...
    <div class="contents">
      ...
      <table class="style_1">
        ...
        <tr>
          <th>구분</th>
          <td>
            <select data-ng-model="form.cate_code" data-ng-options="item.cate_seq as item.subject for item in main.group" data-ng-init="form.cate_code = form.cate_code"></select>
          </td>
        </tr>
        <tr>
          <th>작성자</th>
