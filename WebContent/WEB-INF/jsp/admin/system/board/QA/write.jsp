...
<div id="main">
  <div class="titlebar">
    <h2>자주묻는질문</h2>
    <div> <span>통합관리</span> &gt; <span>시스템관리</span> &gt;<span>자주묻는질문</span> &gt;<span class="bar_tx">등록</span> </div>
  </div>
  <div class="container"> 
    <div class="contents">
      ...
      <table class="style_1">
        ...
        <tr>
          <th>구분</th>
          <td>
            <select data-ng-model="form.cate_code" data-ng-options="item.cate_seq as item.subject for item in main.group" data-ng-init="form.cate_code = main.group[0].cate_seq"></select>
          </td>
        </tr>
        <tr>
          <th>작성자</th>
