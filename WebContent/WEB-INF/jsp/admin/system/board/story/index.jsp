...
app.controller("writeCtrl", function($scope, $window, $routeParams, $rootScope, ajaxService, dialogService) {
	...
	$scope.save = function(){
		...
		ajaxService.getJSON("/admin/system/board/notice/index.do?mode=write", {jData : JSON.stringify($scope.form)}, function(data){
			$scope.list();
		});
	}
});
...
app.controller("modifyCtrl", function($scope, $window, $routeParams, ajaxService, dialogService) {
	...
	ajaxService.getJSON("/admin/system/board/notice/index.do?mode=view", {article_seq : $routeParams.seq, board_seq : $scope.param.board_seq}, function(data){
	...
	$scope.save = function(){
		...
		ajaxService.getJSON("/admin/system/board/notice/index.do?mode=modify", {jData : JSON.stringify($scope.form)}, function(data){
			$scope.list();
		});
	}
	...
	$scope.del = function(){
		if(confirm("삭제하시겠습니까?")){
			ajaxService.getJSON("/admin/system/board/notice/index.do?mode=del", {jData : JSON.stringify($scope.form)}, function(data){
				$scope.list();
			});
		}
	}
