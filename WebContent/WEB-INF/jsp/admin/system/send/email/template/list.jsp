     ...
     <form name="searchFrm" method="post" data-ng-submit="board.go(1)">
      ...
      <table class="style_3">
        ...
        <tr data-ng-repeat="item in board.list">
          ...
          <td>{{item.reg_dt}}</td>
          <td>
             <span class="bt_alls"><span><input type="button" value="수정" data-my-href="/modify/{{item.tp_seq}}" class="btalls"/></span></span>          
          </td>
          <td>
             <span class="bt_alls"><span><input type="button" value="삭제" data-ng-click="del(item.tp_seq)" class="btalls"/></span></span>
          </td>
        </tr>
      </table>
