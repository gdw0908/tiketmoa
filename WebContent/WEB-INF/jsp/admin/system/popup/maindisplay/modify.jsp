...
<div id="main">
  <div class="titlebar">
    <h2>메인화면관리</h2>
    <div> <span>통합관리</span> &gt; <span>팝업관리</span> &gt;<span class="bar_tx">메인화면관리</span> </div>
  </div>
  <div class="container"> 
    <div class="contents">
    <form id="wFrm" name="frm" method="post" novalidate="novalidate" enctype="multipart/form-data">
      <table class="style_1">
        ...
        <tr>
          ...
          <td>
            <label>
              <input type="radio" data-ng-model="form.link_yn" value="Y" /><span>사용</span>  
            </label>
            <label>
        ...
        <tr>
          <th>링크타겟</th>
          <td>
            <select data-ng-model="form.link_target" title="링크타겟 선택 선택">
        ...
        <tr> 
          <td class="tddiv" id="attach_div">
            <div style="margin-top: 3px;" data-ng-if="form.files == ''"><img data-ng-src="{{form.file_path}}" alt="사진" style="width: 125px; height: 60px;"/></div>
	        <div style="margin-top: 3px;" data-ng-if="form.files != ''"><img data-ng-src="/upload/temp/{{form.files[0].uuid}}" alt="사진" style="width: 125px; height: 60px;"/></div>
	      </td>
        </tr>
        <tr>
          <th>이미지설명</th>
        ...
        <tr>
          <th>순서</th>
          <td><input type="text" class="input_1" data-ng-model="form.order_seq" style="width: 5%;" required/></td>
        </tr>
        <tr>
          <th>PC 사용여부</th>
          <td>
        ...
        <tr>
          ...
          <td>
            <label>
              <input type="radio" data-ng-model="form.mobile" value="1"/><span>사용</span>  
            </label>
            <label>
              <input type="radio" data-ng-model="form.mobile" value="0" /><span>사용안함</span>
            </label>
          </td>
        </tr>
      </table>
