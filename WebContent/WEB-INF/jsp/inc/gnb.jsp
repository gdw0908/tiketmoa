...
<div class="main_visual_wrap"> 
  <!-- all_menu -->
  <div class="all_menu" id="allmenu_open"><img src="/images/gnb/all_menu.gif" alt="전체 카테고리" style="cursor:pointer;"></div>
  ...
  <div id="gnbmenu">
    <div class="inner">
      <ul>
        <li class="g1 <c:if test="${param.menu eq 'menu1' }">active</c:if>" <c:if test="${param.menu eq 'menu1' }">id="on_gmenu"</c:if>> <a href="/goods/list.do?menu=menu1"><span class="hide_txt">바디</span></a> 
          <!-- 2depth -->
        ...
        <li class="g2 <c:if test="${param.menu eq 'menu2' }">active</c:if>" <c:if test="${param.menu eq 'menu2' }">id="on_gmenu"</c:if>> <a href="/goods/list.do?menu=menu2"><span class="hide_txt">의장</span></a> 
          <!-- 2depth -->
        ...
        <li class="g3 <c:if test="${param.menu eq 'menu3' }">active</c:if>" <c:if test="${param.menu eq 'menu3' }">id="on_gmenu"</c:if>> <a href="/goods/list.do?menu=menu3"><span class="hide_txt">엔진</span></a> 
          <!-- 2depth -->
        ...
        <li class="g4 <c:if test="${param.menu eq 'menu4' }">active</c:if>" <c:if test="${param.menu eq 'menu4' }">id="on_gmenu"</c:if>> <a href="/goods/list.do?menu=menu4"><span class="hide_txt">샤시</span></a> 
          <!-- 2depth -->
        ...
        <li class="g5 <c:if test="${param.menu eq 'menu5' }">active</c:if>" <c:if test="${param.menu eq 'menu5' }">id="on_gmenu"</c:if>> <a href="/goods/list.do?menu=menu5"><span class="hide_txt">국산차</span></a> 
          <!-- 2depth -->
        ...
        <li class="g6 <c:if test="${param.menu eq 'menu6' }">active</c:if>" <c:if test="${param.menu eq 'menu6' }">id="on_gmenu"</c:if>> <a href="/goods/list.do?menu=menu6"><span class="hide_txt">수입차</span></a> 
          <!-- 2depth -->
       ...
       <li class="g7 <c:if test="${param.menu eq 'menu9' }">active</c:if>" <c:if test="${param.menu eq 'menu9' }">id="on_gmenu"</c:if>> 
        <a href="/goods/contents_list.do?menu=menu9&amp;part2=050901006003"><span class="hide_txt">재제조</span></a> 
          <!-- 2depth -->
