...
<div id="header">
	...
	<div class="mo_menu_wrap">
		<nav>
			<ul class="mo_menu">
				<li><a href="/goods/list.do?menu=menu1">갤러리아</a></li>
				<li><a href="/goods/list.do?menu=menu2">신세계</a></li>
				<li><a href="/goods/list.do?menu=menu3">롯데</a></li>
				<li><a href="/mypage/notice/index.do">고객센터</a></li>
			</ul>
			...
			<ul class="mo_member_wrap">
        		...
        		<li>
        			<c:choose>
          			...
          			<c:otherwise>
          				<a href="/login/login.do?mode=logout">로그아웃</a>
          			</c:otherwise>
          		</c:choose>
       		  </li>
      		</ul>
    ...
    <div class="util_nav">
     <ul>
  	   ...
  	   <li class="cart_item">
  	   	<a href="/mypage/shopping/cart/index.do" class="cart">
     ...
     <ul>
       <li>
        ...
        <li class="first c1"><a href="/mypage/notice/index.do" onclick="window.external.AddFavorite('<spring:eval expression="@config['home.url']" />', 'DBSOUND')">고객센터</a></li>
      </ul>
    </div>
